...
public class JiraUtil {
	...
	public String reporIssue(String summary, String description, String attachmentPath) {
		...
		try {
			...
			LogUtil.infoLog(getClass(), "Logged Bug ID: " + newIssue.getKey());
			ExtentUtil.logger.get().log(Status.INFO, HTMLReportUtil.infoStringBlueColor("Logged Bug ID: " + newIssue.getKey()));
